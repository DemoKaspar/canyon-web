...
<main style={{ position: "relative", zIndex: 5, maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
        ...
        <section style={{ paddingTop: 40, paddingBottom: 40 }}>
          <h1 className="dhero-title" style={{ fontSize: 36, fontWeight: 700, lineHeight: 1.15, letterSpacing: -0.8, color: "rgba(240,224,219,0.97)", margin: "0 0 12px", maxWidth: 680 }}>
            Your infrastructure. We never host your apps.
          </h1>
          <p style={{ fontSize: 16, color: "rgba(240,224,219,0.5)", lineHeight: 1.6, maxWidth: 620, margin: 0 }}>
        ...
        <section style={{ paddingBottom: 48 }}>
          ...
          <p style={{ fontSize: 15, color: "rgba(240,224,219,0.4)", margin: "0 0 20px", maxWidth: 680 }}>
